...
ITEMS = [
    ...
    },
    {
        ...
        "affixes": {"+# Poison Damage over # Seconds": [7, 3]},
        "tooltip": [
            "Blade of Blight",
    ...
    },
    {
        ...
        "affixes": {"+#% Enhanced Damage": [25], "+# to Maximum Damage": [2]},
        "tooltip": [
    ...
    },
    {
        ...
        "stats": {"defense": 16},
        "affixes": {"Fire Resist +#%": [5], "Poison Length Reduced by #%": [25]},
        "tooltip": [
    ...
    },
    {
        ...
        "stats": {},
        "affixes": {"+#% Faster Cast Rate": [10], "+# to Mana": [78]},
        "tooltip": [
    ...
    },
    {
        ...
        "stats": {},
        "affixes": {"+# to [Skill] ([Class] only)": [1, "Martial Arts", "Assassin"], "+# to Life": [23]},
        "tooltip": [
    ...
    },
    {
        ...
        "affixes": {
            ...
            "+#% Enhanced Defense": [85],
            "Lightning Resist +#%": [14],
            "Repairs 1 durability in # seconds": [20],
        },
        "tooltip": [
            "Havoc Knuckle",
            "Sharkskin Gloves",
    ...
    },
    {
        ...
        "stats": {"defense": 1596},
        "affixes": {
            "20% Chance to Cast Level 15 Chilling Armor When Struck": [20, 15],
            "+25% Faster Cast Rate": [25],
            "+300% Enhanced Damage": [300],
            "+215% Enhanced Defense": [215],
            "+15 Defense": [15],
            "+101 to Life (Based on Character Level)": [101],
            "Replenish Life +7": [7],
            "+5% to Maximum Lightning Resist": [5],
            "All Resistances +29": [29],
            "Damage Reduced by 7": [7],
            "+12% Damage Taken Goes To Mana": [12],
            "+1 to Light Radius": [1],
            "Increase Maximum Durability 13%": [13],
            "Socketed (4)": [4],
        },
        "tooltip": [
            "Fortitode",
    ...
    },
    {
        ...
        "stats": {"defense": 358},
        "affixes": {
            "#% Chance to Cast Level 15 Poison Nova When struck": [15, 15],
            "+# to all Skills": [2],
            "+#% Increased Attack Speed": [20],
    ...
    },
    {
        ...
        "stats": {},
        "affixes": {
            "#% Chance to cast level # Firestorm on Striking": [5, 10],
